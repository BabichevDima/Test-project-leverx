    ...
    return BaseController.extend('dmitry.babichev.controller.StoreDetails', {
      ...
      onFilterSelect: function(oEvent) {
        ...
        oItemsBinding.filter(
          new Filter('Status', FilterOperator.Contains, key)
        );
        oAppViewModel.setProperty(
          '/activeStatusFilter',
          oItemsBinding.getFilters('Control')[0]
        );
      },
      ...
      onSortButtonPress: function(sProperty) {
        var oSortFilterModel = this.getView().getModel('appView');
        var oSorter = '';
